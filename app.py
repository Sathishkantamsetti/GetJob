...
"""
from GetJobConfig import dbhost,dbuser,dbpass,db
...
app.secret_key='Fox'
app.config['MYSQL_HOST'] = dbhost    #'localhost' or 'mysqlserver'
app.config['MYSQL_USER'] = dbuser #'root'
app.config['MYSQL_PASSWORD']= dbpass#''
app.config['MYSQL_DB'] = db #'getAjobdb'
mysql = MySQL(app)
